...
const createNotification = (userId, notificationId, type, message, seen) => {
...
const drawNotifications = async (userId) => {
  try {
    ...
    sortedNotifications.forEach((notification) => {
      createNotification(userId, notification._id, notification.type, notification.message, notification.seen);
    });
  } catch (error) {
    console.error(error);
  }
